...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__my_evolve(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__my_evolve(void) { return NULL; }
#  else
     init_my_evolve(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit__my_evolve(void)
{
  return _cffi_init("_my_evolve", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_my_evolve(void)
{
  _cffi_init("_my_evolve", 0x2601, &_cffi_type_context);
}
#endif
